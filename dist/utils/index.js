...
var fmtStr = function (_a, err) {
    ...
    return err
        ? ch.bold.bgRed(title) + ch.red.apply(ch, tslib_1.__spread(msg))
        : ch.bold.bgBlue.white(title) + ch.green.apply(ch, tslib_1.__spread(msg));
};
var getPkg = function (p) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    switch (_a.label) {
...
var writeFileCB = function (e, sPath, cmdName, del) {
    if (e) {
        ...
        process.exitCode = 0;
        return validMsg(constants_1.msgOpts[del ? 'DEL_SUCCESS' : 'ADD_SUCCESS'](sPath, cmdName));
    }
};
